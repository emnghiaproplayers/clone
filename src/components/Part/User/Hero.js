        ...
        <div className="container mx-auto">
            <div className="flex items-center flex-col lg:flex-row lg:gap-x-[60px]">
                <div className="flex-1 mt-8 lg:min-w-[620px] text-center lg:text-left order-1 lg:-order-1">
                    ...
                    <h1 className=" font-secondary font-extrabold text-[30px] lg:text-[48px] lg:leading-tight lg:max-w-[855px] text-[#0047AB]">{title2}</h1>
                    <h2 className="my-[20px] text-lg">{subtitle}</h2>
                    <button className="bg-[#0047AB] hover:bg-[#22354f] px-[36px] py-[18px] mt-[10px] hover:transform-[scale3d(1.05,1.05,1.05)] text-xl font-semibold text-white rounded-[32px]  backdrop-blur-md transition  transform hover:scale-105">{buttonText}</button>
                </div>
