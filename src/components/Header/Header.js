        ...
        <div className="container mx-auto">
            <div className="flex justify-between items-center">
                <a href="/" className="uppercase text-xl">
                   ...
                   <span className="font-bold text-[#0047AB]">Wanderer</span> 
                </a>
                {/* menu icon*/}
                ...
                <button className={`${btnColor ? 'bg-[#0047AB] hover:bg-[#3b6095] text-white ' : 'bg-[#eef0f2] hover:bg-grey-1 text-second'}  px-[40px] py-[9px] my-1 hover:transform-[scale3d(1.05,1.05,1.05)] text-sm font-semibold  rounded-full  backdrop-blur-md transition  transform hover:scale-105 hidden md:flex`}>Login</button>
